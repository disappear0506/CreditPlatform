...
@Controller
@Scope("prototype")
public class GrowUpAction implements ModelDriven<Activity>{
	@Resource
	...
	@Action(value = "growUpPublish1", results = { @Result(location = "/WEB-INF/publish1.jsp") })
	...
	@Action(value="growUpFindPageBean",
	...
	public String appointFindPageBean(){
		...
		PageBean<Activity> pageBean=activityService.findByPage(currPage, 3);
		//将pageBean存放到值栈中
