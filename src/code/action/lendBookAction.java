...
@Controller
@Scope("prototype")
public class lendBookAction extends ActionSupport implements ModelDriven<Activity> {
	@Resource
	...
	@Action(value = "lendBookPublish1", results = { @Result(location = "/WEB-INF/publish1.jsp") })
	...
	@Action(value="lendBookFindPageBean",
	...
	public String appointFindPageBean(){
		...
		PageBean<Activity> pageBean=activityService.findByPage(currPage, 2);
//		将pageBean存放到值栈中
