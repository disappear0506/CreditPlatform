...
@Controller
@Scope("prototype")
public class LeaveMarketAction implements ModelDriven<Activity>{
	@Resource
	...
	@Action(value = "leaveMarketPublish1", results = { @Result(location = "/WEB-INF/publish1.jsp") })
	...
	@Action(value="leaveMarketFindPageBean",
	...
	public String appointFindPageBean(){
		...
		PageBean<Activity> pageBean=activityService.findByPage(currPage, 4);
		//将pageBean存放到值栈中
