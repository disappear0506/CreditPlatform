...
<title>互借书</title>
<link href="css/lendBook.css" rel="stylesheet" type="text/css" />
<script src="js/jquery-1.11.1.js"></script>
<script src="js/lendBook.js"></script>
</head>
...
<div id="top">
    ...
    <a class="naviga_onclick" href="#" target="_self">互借书</a>
...
<div id="main">
    ...
    <div class="page">
        ...
        <s:if test="currPage!=1">
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/lendBookFindPageBean.action?currPage=1">[首页]</a></span>
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/lendBookFindPageBean.action?currPage=<s:property value="currPage-1"/>">[上一页]</a></span>
        </s:if>
        <s:if test="currPage!=totalPage">
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/lendBookFindPageBean.action?currPage=<s:property value="currPage+1"/>">[下一页]</a></span>
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/lendBookFindPageBean.action?currPage=<s:property value="totalPage"/>">[尾页]</a></span>
    	</s:if>
    </div>
</div>
<div id="foot">
