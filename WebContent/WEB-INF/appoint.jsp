...
<link href="css/selectes.css" rel="stylesheet" type="text/css" />
<script src="js/jquery-1.11.1.js"></script>
<script src="js/appoint.js"></script>
<script src="js/selectes.js"></script>
</head>
...
<div id="top">
    ...
    <a class="naviga_onclick" href="#" target="_self">约起来</a>
...
<div id="classifyku">
	<div id="classifymain">
		...
		<dl id="select1">
        	<dt class="type">活动进程：</dt>
            <dd class="content selected" >全部</dd>
            <dd class="content">已通过</dd>
            <dd class="content">进行中</dd>
            <dd class="content">已结束</dd>
        </dl>   
        </div>
        <!--  
...
<div id="main">
    ...
    <div class="page">
        ...
        <s:if test="currPage!=1">
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/appointFindPageBean.action?currPage=1">[首页]</a></span>
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/appointFindPageBean.action?currPage=<s:property value="currPage-1"/>">[上一页]</a></span>
        </s:if>
        <s:if test="currPage!=totalPage">
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/appointFindPageBean.action?currPage=<s:property value="currPage+1"/>">[下一页]</a></span>
        	<span class="pageitem"><a href="${pageContext.request.contextPath}/appointFindPageBean.action?currPage=<s:property value="totalPage"/>">[尾页]</a></span>
    	</s:if>
    </div>
